...
- Islamic rulings regarding student loans
- Understanding OSAP terminology
...
```bash
git clone https://github.com/SamahaCore/osapformuslims.git
cd osapformuslims
```
...
5. Push to your fork and submit a pull request
   (If you're resolving an issue, don't forget to tag it!)

### Content Structure

The site content is organized in the following directories:
